...
export default function PodcastsScreen() {
  return <SafeAreaView style={styles.safe}><View style={styles.page}><Text style={styles.kicker}>À RÉÉCOUTER</Text><Text style={styles.title}>Podcasts</Text><Text style={styles.text}>Le lecteur des podcasts arrive dans la prochaine étape.</Text></View></SafeAreaView>;
}
