    ...
    <SafeAreaView style={styles.safe}>
      <ScrollView contentContainerStyle={styles.page}>
        ...
        <View style={styles.liveCard}>
          ...
          <View style={styles.trackRow}>
            <View style={styles.coverWrap}>
              {nowPlaying?.cover ? (
                <Image source={{ uri: nowPlaying.cover }} style={styles.cover} />
              ) : (
                <View style={[styles.cover, styles.coverFallback]}><Text style={styles.coverText}>ÉD</Text></View>
              )}
            </View>
        ...
        <View style={styles.section}>
          <Text style={styles.sectionKicker}>V1 EN CONSTRUCTION</Text>
          <Text style={styles.sectionTitle}>L’Écho du Der dans ta poche.</Text>
          <Text style={styles.sectionText}>Le lecteur live est déjà relié à la radio. Les prochains écrans reprendront les actualités, artistes locaux, podcasts, partenaires, votes et demandes de titres.</Text>
        </View>
      </ScrollView>
    </SafeAreaView>
  );
...
const styles = StyleSheet.create({
  ...
  page: { flexGrow: 1, paddingHorizontal: 20, paddingTop: 24, paddingBottom: 40 },
